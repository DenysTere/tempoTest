          ...
          {type === "loading" ? (
            ...
            <div className="space-y-4 mt-2">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="border border-gray-200 rounded-xl p-4 hover:border-pink-300 hover:shadow-md transition-all duration-300">
                  <div className="text-center mb-3">
                    <h3 className="font-medium text-lg text-pink-800">
                      Basic Plan
                    </h3>
                    <p className="text-2xl font-bold text-gray-800 my-2">$29</p>
                    <p className="text-xs text-gray-500">One-time payment</p>
                  </div>
                  <ul className="text-sm space-y-2 mb-4">
                    <li className="flex items-start">
                      <span className="text-pink-500 mr-2">✓</span> Color
                      analysis
                    </li>
                    <li className="flex items-start">
                      <span className="text-pink-500 mr-2">✓</span> Body shape
                      guide
                    </li>
                    <li className="flex items-start">
                      <span className="text-pink-500 mr-2">✓</span> Basic
                      wardrobe essentials
                    </li>
                  </ul>
                  <button
                    onClick={onContinue}
                    className="w-full py-2 rounded-lg bg-pink-100 text-pink-800 font-medium hover:bg-pink-200 transition-all duration-300"
                  >
                    Choose Basic
                  </button>
                </div>
                <div className="border-2 border-pink-400 rounded-xl p-4 shadow-md relative">
                  ...
                  <div className="text-center mb-3">
                    ...
                    <p className="text-2xl font-bold text-gray-800 my-2">$49</p>
                    <p className="text-xs text-gray-500">One-time payment</p>
                  </div>
                  <ul className="text-sm space-y-2 mb-4">
                    <li className="flex items-start">
                      <span className="text-pink-500 mr-2">✓</span> Everything
                      in Basic
                    </li>
                    <li className="flex items-start">
                      <span className="text-pink-500 mr-2">✓</span> Seasonal
                      capsule wardrobe
                    </li>
                    <li className="flex items-start">
                      <span className="text-pink-500 mr-2">✓</span> Personal
                      shopping list
                    </li>
                    <li className="flex items-start">
                      <span className="text-pink-500 mr-2">✓</span> Style
                      consultation call
                    </li>
                  </ul>
                  <button
                    onClick={onContinue}
                    className="w-full py-2 rounded-lg bg-gradient-to-r from-pink-500 to-purple-500 text-white font-medium hover:from-pink-600 hover:to-purple-600 transition-all duration-300"
                  >
                    Choose Premium
                  </button>
                </div>
